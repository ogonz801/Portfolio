...
const Skills = () => {
  return (
    <div name='skills' className='w-full container-color'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div>
          <h3 className='text-4xl font-bold inline border-b-4 border-pink-600'>Skills</h3>
          <p className='text-xl py-4 mb-5'>Technologies and Frameworks I've worked with</p>
        </div>
